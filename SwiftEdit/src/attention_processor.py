...
# The code in this file originates from https://github.com/tencent-ailab/IP-Adapter/blob/main/ip_adapter/attention_processor.py
# and is released under an Apache 2.0 license
#
# The code is modified as follows:
# - nonn relevant classes have been removed for brevity
