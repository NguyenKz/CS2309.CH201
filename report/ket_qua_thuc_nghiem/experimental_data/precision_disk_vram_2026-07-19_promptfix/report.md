...
- Timestamp (UTC): `2026-07-19T07:43:49.286148+00:00`
- Device: `mps` | torch `2.12.0` | git `ad83671`
- Configs: baseline_fp32, fp16_disk
- Jobs: 2 (prompt theo mapping PIE-Bench)
...
|---|---:|---:|---:|
| baseline_fp32 | 12366 | 13008 | 20.62 |
| fp16_disk | 6567 | 7163 | 15.81 |

## Quality vs baseline_fp32 (cùng ảnh + prompt)

| Config | n | seconds_mean | PSNR↑ mean | PSNR min | map → bench cũ |
|---|---:|---:|---:|---:|---|
| baseline_fp32 | 2 | 20.886 | 99.0 | 99.0 | baseline_fp32 (quality_speed_bench_2026-06-17) |
| fp16_disk | 2 | 5.464 | 48.768 | 44.15 | gần improved_fp16_cache nhưng weights fp16 trên disk + torch_dtype load |
